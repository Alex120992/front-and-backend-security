...
-- INSERT  INTO users
-- SELECT (NULL, 'happy', '12345', '1');
-- INSERT  INTO authorities
-- SELECT (NULL, 'happy', 'write');
...
(
    ...
    CONSTRAINT customer_ibfk_1 FOREIGN KEY
        (
         customer_id
            ) REFERENCES customer
            (
...
CREATE INDEX customer_id ON accounts
    (
     customer_id
        );
...
(
    ...
    CONSTRAINT accounts_ibfk_2 FOREIGN KEY
        (
         account_number
            ) REFERENCES accounts
            (
    ...
    CONSTRAINT acct_user_ibfk_1 FOREIGN KEY
        (
         customer_id
            ) REFERENCES customer
            (
...
CREATE INDEX customer_id ON account_transactions
    (
     customer_id
        );
CREATE INDEX account_number ON account_transactions
    (
     account_number
        );
...
(
    ...
    CONSTRAINT loan_customer_ibfk_1 FOREIGN KEY
        (
         customer_id
            ) REFERENCES customer
            (
...
CREATE INDEX customer_id ON loans
    (
     customer_id
        );
...
CREATE INDEX customer_id ON cards (customer_id);
